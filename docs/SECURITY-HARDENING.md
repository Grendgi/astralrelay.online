...
- `require-trusted-types-for 'script'` — Trusted Types для innerHTML/script sinks (Chrome, Edge)
- `trusted-types default` — политика default создаётся в main.tsx до рендера React
